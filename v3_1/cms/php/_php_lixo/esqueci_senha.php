...
$conexao = conectar(); 
	...
	function gerar_link($w,$d,$c,$t){ 
		return "http://".$w.$d."/".$c."/php/redefinir_senha_action.php?token=".$t;
	}
	...
	$mensagem .= '<a href="'.gerar_link( $www, $domain, $cms_folder, $token ).'" target="_blank" style="margin-top:20px; padding:12px 50px; background:#333; color:#fff; font-size:18px; font-weight:bold; font-family:Arial, sans-serif; border-radius:10px; display:inline-block; text-decoration:none">REDEFINIR SENHA</a><br><br>';          
